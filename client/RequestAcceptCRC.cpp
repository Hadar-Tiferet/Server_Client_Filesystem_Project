...
RequestAcceptCRC::RequestAcceptCRC(std::string client_id, std::string filepath)
	: Request(client_id, Protocol::request_acceptCRC) {
...
void RequestAcceptCRC::send(boost::asio::ip::tcp::socket* sock) {
